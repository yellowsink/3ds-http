...
import binds.ctru.services.gspgpu;

/// Converts red, green, and blue components to packed RGB565.
enum RGB565(alias r, alias g,alias b) = (((b)&0x1f)|(((g)&0x3f)<<5)|(((r)&0x1f)<<11));

/// Converts packed RGB8 to packed RGB565.
enum RGB8_to_565(alias r, alias g, alias b) = (((b)>>3)&0x1f)|((((g)>>2)&0x3f)<<5)|((((r)>>3)&0x1f)<<11);
