...
import binds.ctru.gfx;

enum CONSOLE_ESC(alias x) = "\x1b[" ~ x;
enum CONSOLE_RESET = CONSOLE_ESC!("0m");
enum CONSOLE_BLACK = CONSOLE_ESC!("30m");
enum CONSOLE_RED = CONSOLE_ESC!("31;1m");
enum CONSOLE_GREEN = CONSOLE_ESC!("32;1m");
enum CONSOLE_YELLOW = CONSOLE_ESC!("33;1m");
enum CONSOLE_BLUE = CONSOLE_ESC!("34;1m");
enum CONSOLE_MAGENTA = CONSOLE_ESC!("35;1m");
enum CONSOLE_CYAN = CONSOLE_ESC!("36;1m");
enum CONSOLE_WHITE = CONSOLE_ESC!("37;1m");
